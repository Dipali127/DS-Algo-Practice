...
// if one tree is empty and the other is not (i.e., p === null || q === null), return false since one tree has more nodes than the other, 
...
// Time Complexity (TC):- O(N), where 'N' is the number of nodes in the smaller of the two trees as each node in
//  both trees are visited exactly once.
