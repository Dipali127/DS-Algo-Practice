...
// We start iterating from the second element in the array, and while iterating, take the current iterated element as the
// "key" and compare it with all the elements that are to the left of the key.
...
// to be compared once with the previous element, and the inner while loop does not run; it only runs once for the first
// comparison with the key, then stops.
