...
// after processing all characters, if the stack is empty, it means all opening parentheses had matching closing parentheses, and the string is valid. If the stack is not empty, return `false` as there are unmatched opening parentheses.
