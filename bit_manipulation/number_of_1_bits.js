...
// Since diving by 2 discard the right most bit(which is LSB).
...
// When iterating through the bits, the number of iterations is proportional to the number of bits in n,
// which is log₂(n).
