...
// approach:-
// iterate through each possible subarray and for each element, check if the current element at index 'i'
// is zero. if it is, increment countZero, which tracks the total number of zeros in the array.
// we need this count because if there are no zeros in the array, the longest subarray of 1's after
// deleting one element will be array.length - 1, as deleting any element will give us the entire array of 1's.
// for each zero encountered, compute the longest subarray of 1's by skipping that particular zero 
// and track the maximum length of such subarrays.
...
// which is valid for finding the longest subarray of 1's after deleting one zero.
