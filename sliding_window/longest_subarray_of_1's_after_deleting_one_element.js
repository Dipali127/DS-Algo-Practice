...
// between `maxLength` and `j - i`, where `j - i` which gives the exact number of 1's from the current 
// subarray after removing one element (i.e., the zero).
...
// TC:- O(N), since we traverse the array at most once with two pointers (i and j).
